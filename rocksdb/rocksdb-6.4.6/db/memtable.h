...
class MemTable {
 public:
  struct KeyComparator : public MemTableRep::KeyComparator {   // 特殊的比较器，比较打包好的keyvalue里的key部分
 ...
 private:
  ...
  std::unique_ptr<MemTableRep> range_del_table_;  // 保存range delete类型的key value
